...
class ListaEncadeada:
    ...
    def insereElementoFormaOrdenada(self, elemento):
        #Metodo que insere um elemento de forma ordenada
        no = No(elemento)
        if self._tamanho == 0:
            apontador = self._cabeca
            self._cabeca = no
            ...
            atual = self._cabeca
            while atual != None and atual.dado < elemento:
                anterior = atual
                atual = atual.proximo
    ...
    def removeElementoQualquer(self, elemento):
        #Metodo que remove a primeira ocorrencia do elemento
        if self._tamanho == 0:
            raise Exception('Lista vazia.')
        atual = self._cabeca
        while atual != None and atual.dado != elemento:
    ...
    def rearranjarLista(self, lista, n):
        #Metodo que rearranja a lista
        if n > 2:
            inicio = 1
            proximo = n // 2
    ...
    def uniao(self, lista):
        #Metodo que faz a uniao entre duas listas
        uniao = ListaEncadeada()
        apontador = self._cabeca
        while apontador != None:
            uniao.insereElementoFormaOrdenada(apontador.dado)
            apontador = apontador.proximo
    ...
    def intersecao(self, lista):
        #Metodo que faz a intersecao entre duas listas
        intersecao = ListaEncadeada()
        i = 0
        apontador = self._cabeca
        auxiliar = lista._cabeca
        while i < self._tamanho:
            while apontador != None:
                while auxiliar != None:
                    if apontador.dado == auxiliar.dado:
                        intersecao.insereElementoFormaOrdenada(apontador.dado)
