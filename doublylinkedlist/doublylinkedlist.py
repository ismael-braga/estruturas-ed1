...
class ListaDuplamenteEncadeada:
    ...
    def removeElementoInicio(self):
        ...
        if self._tamanho != 0:
            if self._tamanho == 1:
                ...
                apontador = self._cabeca.proximo
                self._cabeca = apontador
        else:
    ...
    def criaListaInvertida(self):
        ...
        lista_invertida = ListaDuplamenteEncadeada()
        apontador = self._cabeca
        while apontador != None:
    ...
    def criaCopiaLista(self):
        ...
        lista_copia = ListaDuplamenteEncadeada()
        apontador = self._cabeca
        while apontador != None:
    ...
    def __str__(self):
        #Metodo que mostra a lista para o usuario atraves da funcao print()
        apontador = self._cabeca
        representacao = '\033[1;33m' + '\tCabeça' + '\033[0;0m' + '\n'
        representacao = representacao + '\033[1;34m' + 'None' + '\033[0;0m'
        while apontador != None:
            representacao = representacao + f' <-|*|{apontador.dado}|*|-> '
            if apontador.proximo == None:
                break
